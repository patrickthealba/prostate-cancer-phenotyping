 ...
 * @generated */
public class Benign extends Annotation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Benign.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Benign() {/* intentionally empty block */}
   ...
   */
  public Benign(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Benign(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
