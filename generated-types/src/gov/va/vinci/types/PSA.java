 ...
 * @generated */
public class PSA extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(PSA.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected PSA() {/* intentionally empty block */}
   ...
   */
  public PSA(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public PSA(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
