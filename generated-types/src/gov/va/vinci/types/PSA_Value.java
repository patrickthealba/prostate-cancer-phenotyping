 ...
 * @generated */
public class PSA_Value extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(PSA_Value.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected PSA_Value() {/* intentionally empty block */}
   ...
   */
  public PSA_Value(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public PSA_Value(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
