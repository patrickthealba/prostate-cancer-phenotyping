 ...
 * @generated */
public class Core_Term extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Core_Term.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Core_Term() {/* intentionally empty block */}
   ...
   */
  public Core_Term(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Core_Term(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
