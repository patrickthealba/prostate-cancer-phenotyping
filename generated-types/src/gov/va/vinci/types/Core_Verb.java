 ...
 * @generated */
public class Core_Verb extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Core_Verb.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Core_Verb() {/* intentionally empty block */}
   ...
   */
  public Core_Verb(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Core_Verb(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
