 ...
 * @generated */
public class Questionnaire_Pattern_Type extends AnnotationPatternType_Type {
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = Questionnaire_Pattern.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("gov.va.vinci.types.Questionnaire_Pattern");
  ...
  public int getTarget(int addr) {
      ...
      jcas.throwFeatMissing("Target", "gov.va.vinci.types.Questionnaire_Pattern");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public Questionnaire_Pattern_Type(JCas jcas, Type casType) {
    super(jcas, casType);
