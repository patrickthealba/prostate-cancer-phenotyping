 ...
 * @generated */
public class Metastasis_Negation_Pattern_Type extends AnnotationPatternType_Type {
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = Metastasis_Negation_Pattern.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("gov.va.vinci.types.Metastasis_Negation_Pattern");
  ...
  public String getModifier(int addr) {
      ...
      jcas.throwFeatMissing("Modifier", "gov.va.vinci.types.Metastasis_Negation_Pattern");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public Metastasis_Negation_Pattern_Type(JCas jcas, Type casType) {
    super(jcas, casType);
